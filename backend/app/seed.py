...
BIOLOGY_TOPICS = [
    {
        ...
        "description": "Basic characteristics, classification, and cellular organization of living organisms.",
        "concepts": [
    ...
    },
    {
        ...
        "description": "Standalone module on the major groups of the Plant Kingdom.",
        "concepts": [
