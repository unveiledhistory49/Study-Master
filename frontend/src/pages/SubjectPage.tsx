...
export default function SubjectPage() {
  ...
  if (!subject) {
    return (
      <ProtectedRoute>
        <div className="text-center p-10">Subject not found</div>
      </ProtectedRoute>
    );
  }
    ...
    <ProtectedRoute>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
        <div className="mb-6">
          <Link
            to="/"
            className="text-[var(--text-muted)] hover:text-[var(--accent-blue)] transition-colors inline-flex items-center gap-1 text-sm"
          >
        ...
        <div className="glass-panel p-8 mb-10 flex flex-col md:flex-row items-center md:items-start gap-8 relative overflow-hidden">
          <div className="absolute -right-20 -top-20 w-64 h-64 bg-[var(--accent-blue)] rounded-full mix-blend-multiply filter blur-[100px] opacity-10" />
